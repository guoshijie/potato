...
class WxPayApi
{
	...
	public static function getConfig(){
		$config = new \stdClass();
		if(isset($_GET['platform']) && $_GET['platform']=='mp'){
			$config->APPID = W2xPayConfig::MP_APPID;
			$config->MCHID = W2xPayConfig::MP_APPID;
		}else{
			$config->APPID = W2xPayConfig::OP_APPID;
			$config->MCHID = W2xPayConfig::OP_APPID;
		}
	}
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(self::getConfig()->APPID);//公众账号ID
		$inputObj->SetMch_id(self::getConfig()->MCHID);//商户号
